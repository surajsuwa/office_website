        ...
        <div class="container">
            <div class="relative">
                ...
                @foreach ($activities as $value)
                    <div class="row align-items-center pt-5" style="padding-bottom:120px;">
                        <div class="col-md-6 order-md-2">
                            <figure data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-delay="500">
                                <img src="{{get_image_path('activities',$value->featured_image)}}" class="img-responsive" alt="">
                            </figure>
                        </div>
                        <div class="col-md-6" data-aos="fade-up" data-aos-anchor-placement="top-center">
                            ...
                            </div><a href="#" class="btn btn-rounded btn-primary">Read More</a>
                        </div>
                    </div>
