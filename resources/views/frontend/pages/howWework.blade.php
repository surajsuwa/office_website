...
<main class="overflow-hidden">
            ...
            <div class="row">
                ...
                <div class="col-md-6 section_content">
                    <h1 class="bold display-md-4 text-contrast mb-4" data-aos="fade-up"
                        data-aos-anchor-placement="center-center"> How We Work </h1>
    ...
    <section id="features" class="section features p-0">
        <div class="container">
            ...
            <div class="row gap-y text-center text-md-start flex-column">
                <div class="col-md-4">
                    <img src="assets/images/works/5b2237e5506f2 (1).png" alt="">
